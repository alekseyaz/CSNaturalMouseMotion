...
//		Assert.assertEquals(new Point(60, 60), moves[0]);
//		Assert.assertEquals(new Point(100, 100), moves[moves.Count - 1]);
...
//		Assert.assertEquals(new Point(149, 149), moves[moves.Count - 1]);
//	  }
...
//		Assert.assertEquals(new Point(50, 50), moves[moves.Count - 1]);
//	  }
