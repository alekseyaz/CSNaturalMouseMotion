...
//		factory.Nature = new ScreenAdjustedNature(new Dimension(1800, 1500), new Point(-1000, -1000));
...
//		Assert.assertEquals(new Point(-500, -900), moves[moves.Count - 1]);
//	  }
...
//		Assert.assertEquals(new Point(-1000, -1000), moves[moves.Count - 1]);
//	  }
//	}
